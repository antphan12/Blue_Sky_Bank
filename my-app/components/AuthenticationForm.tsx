            ...
            <header className='flex flex-col gap-5 md:gap-8'>
                <Link href="/" className='cursor-pointer flex items-center gap-1'>
                    <Image
                        ...
                        alt="Blue Sky Logo"
                    />
                    <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>Blue Sky</h1>
                </Link>

                <div className='flex flex-col gap-1 md:gap-3'>
                    <h1 className='text-24 text-36 font-semibold text-gray-900'>
                        ...
                        {type === 'sign-up' && (
                            ...
                            <div className='flex gap-4'>
                                ...
                                <CustomInput
                                    ...
                                    placeholder='Example: 123-56-7890'/>
                            </div>
                            </>
                        )}
